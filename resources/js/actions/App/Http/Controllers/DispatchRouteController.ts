...
const DispatchRouteController = { cancelAllAssignments, cancelDriverAssignments, index, create, store, show, edit, update, destroy, cancelAssignments }

export default DispatchRouteController